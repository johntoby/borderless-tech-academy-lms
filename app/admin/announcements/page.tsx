    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-[#94A3B8] mt-0.5">Broadcast updates to all students</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="space-y-3">
          {announcements.map((a, i) => (
            <div
              key={a.id}
              className="bg-[#111827] border border-[#1E3A5F] rounded-xl p-4 hover:border-[rgba(167,139,250,0.30)] hover:shadow-[0_0_20px_rgba(167,139,250,0.08)] transition-all duration-200 animate-fade-in group"
              style={{ animationDelay: `${i * 40}ms` }}
            >
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 rounded-lg bg-[rgba(167,139,250,0.10)] border border-[rgba(167,139,250,0.22)] flex items-center justify-center shrink-0 mt-0.5">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <Button
                      ...
                      className="shrink-0 opacity-0 group-hover:opacity-100 transition-opacity text-[#64748B] hover:text-[#F87171]"
                    >
                      <Trash2 size={13} />
                    </Button>
                  </div>
                  <p className="text-sm text-[#94A3B8] mt-1 whitespace-pre-wrap line-clamp-3">{a.body}</p>
                  <p className="text-[11px] text-[#64748B] mt-2" style={{ fontFamily: 'var(--font-mono)' }}>
